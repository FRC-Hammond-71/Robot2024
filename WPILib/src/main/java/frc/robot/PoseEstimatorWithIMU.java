 ...
 */
public class PoseEstimatorWithIMU<T extends WheelPositions<T>> {
  ...
  private class InterpolationRecord implements Interpolatable<InterpolationRecord> {
    ...
    public boolean equals(Object obj) {
      ...
      if (!(obj instanceof PoseEstimatorWithIMU.InterpolationRecord)) {
        return false;
      }
      var record = (PoseEstimatorWithIMU<?>.InterpolationRecord) obj;
