...
public class LauncherFiringSolution implements Sendable
{
    ...
    protected LauncherFiringSolution(Rotation2d angle, double speed, Translation3d target)
    {
        this.ArmAngle = angle;
    ...
    public static LauncherFiringSolution CalculateToSpeaker(Pose2d robotPose)
    {
        ...
        return new LauncherFiringSolution(launchAngle, launchSpeed, Constants.RedField.SpeakerPosition);
    }
